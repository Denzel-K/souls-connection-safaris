    ...
    <section className="px-6 py-20 md:py-32 lg:py-40 bg-lux-shell" id="presence">
      <div className="max-w-5xl mx-auto">
        ...
        <motion.h2
          ...
          className="font-niconne text-4xl md:text-5xl lg:text-6xl text-lux-ink mb-3 md:mb-4 leading-tight text-center font-light"
        >
        ...
        <motion.p
          ...
          className="font-niconne text-lg md:text-2xl lg:text-3xl text-lux-ink/70 mb-8 md:mb-12 lg:mb-16 max-w-3xl font-light leading-relaxed text-center mx-auto"
        >
