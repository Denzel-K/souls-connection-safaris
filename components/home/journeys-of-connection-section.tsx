      ...
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="flex flex-col gap-3 md:flex-row items-center md:justify-between">
          <div>
            ...
            <h2 className="font-niconne text-5xl md:text-6xl text-lux-forest font-light">Five signature journeys</h2>
            ...
            >
              ...
              <div className="flex flex-col flex-1 p-6">
                <div className="flex-1">
                  <h3 className="font-niconne text-2xl md:text-3xl text-lux-forest mb-3 font-light leading-none whitespace-nowrap overflow-hidden text-ellipsis">{j.title}</h3>
